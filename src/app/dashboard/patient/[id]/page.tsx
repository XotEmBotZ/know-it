...
export default function PatientHistoryPage({
    ...
    async function init() {
      ...
      try {
        const [profile, hist, tests, refs] = await Promise.all([
          ...
          dal.getReferralForDoctorAndPatient(user.id, id)
        ])
        setData({
  ...
  const { patientProfile, history, testResults, referrals, user } = data
            ...
            <div className="flex gap-2">
              ...
              <div className="hidden sm:flex gap-2">
                <ReferSpecialistDialog
                  ...
                  onSubmit={async () => {}} // Handle revalidation or refresh
                />
